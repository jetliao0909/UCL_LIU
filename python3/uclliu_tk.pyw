...
GUI_FONT_12 = tk.font.Font(family=GLOBAL_FONT_FAMILY, size=12) 
GUI_FONT_14 = tk.font.Font(family=GLOBAL_FONT_FAMILY, size=14, weight="bold")  #{"FONT_NAME": GLOBAL_FONT_FAMILY, "FONT_SIZE": int( float(config['DEFAULT']['ZOOM'])*14), "FONT_WEIGHT": wx.BOLD };
GUI_FONT_16 = tk.font.Font(family=GLOBAL_FONT_FAMILY, size=16, weight="bold")  #{"FONT_NAME": GLOBAL_FONT_FAMILY, "FONT_SIZE": int( float(config['DEFAULT']['ZOOM'])*16), "FONT_WEIGHT": wx.BOLD };
GUI_FONT_18 = tk.font.Font(family=GLOBAL_FONT_FAMILY, size=18, weight="bold")  #{"FONT_NAME": GLOBAL_FONT_FAMILY, "FONT_SIZE": int( float(config['DEFAULT']['ZOOM'])*18), "FONT_WEIGHT": wx.BOLD };
GUI_FONT_20 = tk.font.Font(family=GLOBAL_FONT_FAMILY, size=20, weight="bold")  #{"FONT_NAME": GLOBAL_FONT_FAMILY, "FONT_SIZE": int( float(config['DEFAULT']['ZOOM'])*20), "FONT_WEIGHT": wx.BOLD };
GUI_FONT_22 = tk.font.Font(family=GLOBAL_FONT_FAMILY, size=22, weight="bold")  #{"FONT_NAME": GLOBAL_FONT_FAMILY, "FONT_SIZE": int( float(config['DEFAULT']['ZOOM'])*22), "FONT_WEIGHT": wx.BOLD };
GUI_FONT_26 = tk.font.Font(family=GLOBAL_FONT_FAMILY, size=26, weight="bold")  #{"FONT_NAME": GLOBAL_FONT_FAMILY, "FONT_SIZE": int( float(config['DEFAULT']['ZOOM'])*26), "FONT_WEIGHT": wx.BOLD };
...
win = ttk.Frame(app, padding=10)

style = ttk.Style()
style.configure("Horizontal.TFrame", background="blue")
# 將窗口設置爲自動佈局(自動展開)
#win.SetAutoLayout(True)
win.pack(expand=True, fill=tk.BOTH, padx=1, pady=1)
...
def set_UI_size(uiDom, width, height):
    style = ttk.Style()
    style.configure("xx", width=width, height=height)
    uiDom.configure(style="xx")
...
win.master.geometry("+"+(str(config["DEFAULT"]["X"]) +"+"+ str(config["DEFAULT"]["Y"])))
#= tk.Frame(self.master, width=200, height=100, bg="lightblue")
...
hbox = ttk.Frame(win, style="Horizontal.TFrame", height=40)
#vbox.pack_start(hbox, False)
#vbox.Add(hbox, proportion=0, flag=wx.EXPAND)

uclen_btn = tk.Button(hbox, text="肥")
#uclen_btn.SetFont(wx.Font(int(GUI_FONT_22["FONT_SIZE"]), wx.DEFAULT, wx.NORMAL, GUI_FONT_22["FONT_WEIGHT"],False,GUI_FONT_22["FONT_NAME"]))
uclen_btn.config(font=GUI_FONT_22)
#uclen_btn.SetLabelVerticalAlignment(wx.VERTICAL_ALIGNMENT_CENTER)
#uclen_btn.connect("clicked",uclen_btn_click)
# 肥的點擊事件
uclen_btn.bind("<Button-1>", uclen_btn_click)
#uclen_btn.SetMinSize((int(float(config['DEFAULT']['ZOOM'])*40) ,int(float(config['DEFAULT']['ZOOM'])*40 ))) 
#uclen_btn.config(width=(int(float(config['DEFAULT']['ZOOM'])*40)) , height=(int(float(config['DEFAULT']['ZOOM'])*40) ))
uclen_btn.pack()
set_UI_size(uclen_btn, (int(float(config['DEFAULT']['ZOOM'])*40)), (int(float(config['DEFAULT']['ZOOM'])*40)))
#hbox.Add(uclen_btn, 0, wx.LEFT | wx.ALIGN_CENTER_VERTICAL, 5)

hf_btn=tk.Button(hbox, text="半")
#hf_btn.SetFont(wx.Font(int(GUI_FONT_22["FONT_SIZE"]), wx.DEFAULT, wx.NORMAL, GUI_FONT_22["FONT_WEIGHT"],False,GUI_FONT_22["FONT_NAME"]))
hf_btn.config(font=GUI_FONT_22)
#hf_btn.SetLabelVerticalAlignment(wx.VERTICAL_ALIGNMENT_CENTER)
hf_btn.bind("<Button-1>", hf_btn_click)
#hf_btn.SetMinSize((int(float(config['DEFAULT']['ZOOM'])*40) ,int(float(config['DEFAULT']['ZOOM'])*40 ))) 
hf_btn.config(width=(int(float(config['DEFAULT']['ZOOM'])*40)) , height=(int(float(config['DEFAULT']['ZOOM'])*40) ))
hf_btn.pack()
#hbox.Add(hf_btn, 0, wx.LEFT | wx.ALIGN_CENTER_VERTICAL, 5)

#type_label = wx.StaticText(win, label="xxxx")
type_label = ttk.Label(win, text="") # , width=(int(float(config['DEFAULT']['ZOOM'])*100))) 
style = ttk.Style()
style.configure("TLabel", width=(int(float(config['DEFAULT']['ZOOM'])*100)))
type_label.configure(style="TLabel")

type_label.config(font=GUI_FONT_22)
#type_label.SetFont(wx.Font(int(GUI_FONT_22["FONT_SIZE"]), wx.DEFAULT, wx.NORMAL, GUI_FONT_22["FONT_WEIGHT"],False,GUI_FONT_22["FONT_NAME"]))
...
type_label.config(background="#DEDEDE")
#type_label.SetMinSize((int(float(config['DEFAULT']['ZOOM'])*100) ,int(float(config['DEFAULT']['ZOOM'])*40 ))) 
#type_label.config(width=(int(float(config['DEFAULT']['ZOOM'])*100)) , height=(int(float(config['DEFAULT']['ZOOM'])*40) ))
type_label.pack()
...
word_label = ttk.Label(win, text="") #, width=(int(float(config['DEFAULT']['ZOOM'])*350))) 

style = ttk.Style()
style.configure("TLabel", width=(int(float(config['DEFAULT']['ZOOM'])*350)))
word_label.configure(style="TLabel")

#word_label.SetFont(wx.Font(int(GUI_FONT_20["FONT_SIZE"]), wx.DEFAULT, wx.NORMAL, GUI_FONT_20["FONT_WEIGHT"],False,GUI_FONT_20["FONT_NAME"]))
word_label.config(font=GUI_FONT_20)
#word_label.SetBackgroundColour(wx.Colour(222, 222, 222))
word_label.config(background="#DEDEDE")

#word_label.SetMinSize((int(float(config['DEFAULT']['ZOOM'])*350) ,int(float(config['DEFAULT']['ZOOM'])*40 ))) 
#word_label.config(width=(int(float(config['DEFAULT']['ZOOM'])*350)) , height=(int(float(config['DEFAULT']['ZOOM'])*40) ))
word_label.pack()
...
simple_btn=tk.Button(hbox, text="")
#simple_btn.SetMinSize((0 ,int(float(config['DEFAULT']['ZOOM'])*40 ))) 
simple_btn.config(width=0, height=(int(float(config['DEFAULT']['ZOOM'])*40) ))
#simple_btn.SetFont(wx.Font(int(GUI_FONT_16["FONT_SIZE"]), wx.DEFAULT, wx.NORMAL, GUI_FONT_16["FONT_WEIGHT"],False,GUI_FONT_16["FONT_NAME"]))
simple_btn.config(font=GUI_FONT_16)
simple_btn.pack()
...
gamemode_btn=tk.Button(hbox, text="正常模式")
#gamemode_btn.SetFont(wx.Font(int(GUI_FONT_12["FONT_SIZE"]), wx.DEFAULT, wx.NORMAL, GUI_FONT_12["FONT_WEIGHT"],False,GUI_FONT_12["FONT_NAME"]))
gamemode_btn.config(font=GUI_FONT_12)
gamemode_btn.bind("<Button-1>", gamemode_btn_click)
#gamemode_btn.SetMinSize((int(float(config['DEFAULT']['ZOOM'])*80) ,int(float(config['DEFAULT']['ZOOM'])*40 ))) 
gamemode_btn.config(width=(int(float(config['DEFAULT']['ZOOM'])*80)) , height=(int(float(config['DEFAULT']['ZOOM'])*40) ))
gamemode_btn.pack()
...
x_btn=tk.Button(hbox, text="╳")
#x_btn.SetFont(wx.Font(int(GUI_FONT_14["FONT_SIZE"]), wx.DEFAULT, wx.NORMAL, GUI_FONT_14["FONT_WEIGHT"],False,GUI_FONT_14["FONT_NAME"]))
x_btn.config(font=GUI_FONT_14)
#x_btn.SetMinSize((int(float(config['DEFAULT']['ZOOM'])*40) ,int(float(config['DEFAULT']['ZOOM'])*40 ))) 
x_btn.config(width=(int(float(config['DEFAULT']['ZOOM'])*40)) , height=(int(float(config['DEFAULT']['ZOOM'])*40) ))
#x_btn.SetLabelVerticalAlignment(wx.VERTICAL_ALIGNMENT_CENTER)
x_btn.bind("<Button-1>", x_btn_click)
x_btn.pack()
...
class TrayIcon():
    ...
    def reload_tray(self):
      ...
      if gamemode_btn.cget("text")=="正常模式":
